...
class MergeSortReverseTest {
	...
	void twoItems() {
		...
		assertAll(()-> assertEquals(12 ,list.get(1).intValue()),
	...
	void tenItems() {
		...
		assertAll(()-> assertEquals(5 ,list.get(9).intValue()),
				  ()-> assertEquals(12 ,list.get(8).intValue()),
				  ()-> assertEquals(13 ,list.get(7).intValue()),
				  ()-> assertEquals(19 ,list.get(6).intValue()),
				  ()-> assertEquals(25 ,list.get(5).intValue()),
				  ()-> assertEquals(33 ,list.get(4).intValue()),
				  ()-> assertEquals(66 ,list.get(3).intValue()),
				  ()-> assertEquals(78 ,list.get(2).intValue()),
				  ()-> assertEquals(85 ,list.get(1).intValue()),
	...
	void elevenItems() {
		...
		assertAll(()-> assertEquals(5 ,list.get(10).intValue()),
				  ()-> assertEquals(12 ,list.get(9).intValue()),
				  ()-> assertEquals(13 ,list.get(8).intValue()),
				  ()-> assertEquals(19 ,list.get(7).intValue()),
				  ()-> assertEquals(25 ,list.get(6).intValue()),
				  ()-> assertEquals(33 ,list.get(5).intValue()),
				  ()-> assertEquals(66 ,list.get(4).intValue()),
				  ()-> assertEquals(78 ,list.get(3).intValue()),
				  ()-> assertEquals(85 ,list.get(2).intValue()),
